    ...
    <div class="row" ng-app="MasterApp" ng-controller="MasterController">
        <div class="col-sm-3 mb-2 mb-sm-0"> 
            <ul class="list-group">
                ...
                <a class="list-group-item list-group-item-action align-items-center d-flex {{ Route::is(['pictogram.index']) ? "active" : null }}" href="{{ route('pictogram.index') }}"><i class="bi bi-boxes fa-2x me-2"></i> Pictogram</a>
            </ul>
        </div> 
