...
@section('content')
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card shadow-hover animate__animated animate__fadeIn">
                <a href="#" class="card-body btn">
                    <i class="text-warning fa fa-file-text fa-2x mb-2"></i>
        ...
        <div class="col-md-3">
            <div class="card shadow-hover animate__animated animate__fadeIn">
                <a href="#" class="card-body btn">
                    <i class="text-warning fa fa-bell fa-2x mb-2"></i>
        ...
        <div class="col-md-3">
            <div class="card shadow-hover animate__animated animate__fadeIn">
                <a href="#" class="card-body btn">
                    <i class="text-warning fa fa-search fa-2x mb-2"></i>
        ...
        <div class="col-md-3">
            <div class="card shadow-hover animate__animated animate__fadeIn">
                <a href="#" class="card-body btn">
                    <i class="text-warning fa fa-bitbucket fa-2x mb-2"></i>
        ...
        <div class="col-md-3">
            <div class="card shadow-hover animate__animated animate__fadeIn">
                <a href="#" class="card-body btn">
                    <i class="text-warning fa fa-exclamation-circle fa-2x mb-2"></i>
        ...
        <div class="col-md-3">
            <div class="card shadow-hover animate__animated animate__fadeIn">
                <a href="#" class="card-body btn">  
                    <i class="text-warning fa fa-external-link-square fa-2x mb-2"></i>
