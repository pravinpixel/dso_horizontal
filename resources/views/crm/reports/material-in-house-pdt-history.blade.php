                ...
                <div class="col-8">
                    <div class="table-fillters row m-0 border">
                        <div class="col">
                            ...
                            <input type="date" name="StartDate" id="StartDateFilter" class="form-control custom" placeholder="DD/MM/YYYY" onchange="filterTable(this)">
                        </div>
                        <div class="col">
                            <label for="" class="form-label">End Date</label>
                            <input type="date" name="EndDate" id="EndDateFilter" class="form-control custom" placeholder="DD/MM/YYYY" onchange="filterTable(this)">
                        </div> 
                        <div class="col">
                    ...
                    <div class="table-fillters row m-0 p-0">
                        @foreach ($filters as $index => $filter)
                            <div class="col">
                                ...
                                <select id="{{ str_replace(' ','',$index) }}Filter" name="{{ str_replace(' ','',$index) }}" ng-model="advanced_filter.category_selection" class="form-select custom" onchange="filterTable(this)">
...
@section('scripts')
    <style>.dataTables_length{display: none !important}</style>
            ...
            load_data = (filters) => {
                $('#historyTable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: "TransactionDate",name: "created_at"},
                        {data: "TransactionTime",name: "created_at"},
