<div class="row m-0">
    ...
    <div class="col-md-6">
        ...
        <div class="row m-0 y-center my-2">
            ...
            <div class="col-8">
               <input type="text" class="form-control form-select-sm" name="dod" placeholder="DD / MM / YYYY"value="@if(isset($batch->disposed_after)){{$batch->disposed_after}}@endif" readonly>
