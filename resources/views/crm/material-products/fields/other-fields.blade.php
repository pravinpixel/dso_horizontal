...
<div class="col-lg-6 my-1">
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::select('extended_qc_status', ['Fail','Pass'] , $material_product->extended_qc_status ?? null, ['class' =>'form-select form-select-sm', 'placeholder' => '-- Select --' , 'required',in_house_type()])  !!}
        </div>
    </div>
</div>
<div class="col-lg-6 my-1">
...
<div class="col-lg-6 my-1">
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::select('used_for_td_expt_only', ['No','Yes'] , $material_product->used_for_td_expt_only ?? null, ['class' =>'form-select form-select-sm', 'placeholder' => '-- Select --' , 'required',in_house_type()])  !!}
        </div>
    </div>
</div>
