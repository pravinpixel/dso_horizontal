...
<div class="col-lg-6 my-1">
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
            {!! Form::text('project_name', $batch->project_name ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...',
...
<div class="col-lg-6 my-1">
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
            {!! Form::text('material_product_type', $batch->material_product_type ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...',
...
<div class="col-lg-6 my-1">
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::number('cost_per_unit', $batch->cost_per_unit ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...',
