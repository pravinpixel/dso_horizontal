        ...
        <div class="col-8 ">
            <div class="d-flex y-center border rounded p-0">
                {!! Form::file('sds',  ['class' => 'form-control form-control-sm border-0', 'placeholder' => 'Type here...',
                    config(is_disable(category_type() ?? $material_product->category_selection)."sds.status")
                ]) !!}
            </div>
        </div>
    </div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
            {!! Form::text('cas', $batch->cas ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
                config(is_disable(category_type() ?? $material_product->category_selection)."cas.status")
            ]) !!}
        </div>
    </div>
</div>
        ...
        <div class="col-8">
            <div class="form-control form-control-sm">                 
                {!! Form::checkbox('fm_1202', $batch->fm_1202 ?? null , true, ['class' => 'form-check-input me-2','required',
                    config(is_disable(category_type() ?? $material_product->category_selection)."fm_1202.status")
                ]) !!}
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
            {!! Form::text('project_name', $batch->project_name ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
                config(is_disable(category_type() ?? $material_product->category_selection)."project_name.status")
            ]) !!}
        </div>
    </div>
</div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
            {!! Form::text('material_product_type', $batch->material_product_type ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
                config(is_disable(category_type() ?? $material_product->category_selection)."material_product_type.status")
            ]) !!}
        </div>
    </div>
</div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::number('alert_threshold_qty_upper_limit', $material_product->alert_threshold_qty_upper_limit ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
            config(is_disable(category_type() ?? $material_product->category_selection)."alert_threshold_qty_upper_limit.status")
           ]) !!}
        </div>
    </div>
</div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::number('alert_threshold_qty_lower_limit', $material_product->alert_threshold_qty_lower_limit ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
            config(is_disable(category_type() ?? $material_product->category_selection)."alert_threshold_qty_lower_limit.status")
           ]) !!}
        </div>
    </div>
</div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::number('alert_before_expiry', $material_product->alert_before_expiry ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
            config(is_disable(category_type() ?? $material_product->category_selection)."alert_before_expiry.status")
           ]) !!}
        </div>
    </div>
</div> 
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
            {!! Form::date('date_of_manufacture', $batch->date_of_manufacture ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
                config(is_disable(category_type() ?? $material_product->category_selection)."date_of_manufacture.status")
            ]) !!}
        </div>
    </div>
</div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
            {!! Form::date('date_of_shipment', $batch->date_of_shipment ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
                config(is_disable(category_type() ?? $material_product->category_selection)."date_of_shipment.status")
            ]) !!}
        </div>
    </div>
</div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::number('cost_per_unit', $batch->cost_per_unit ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
            config(is_disable(category_type() ?? $material_product->category_selection)."cost_per_unit.status")
           ]) !!}
        </div>
    </div>
</div>
    ...
    <div class="row m-0 y-center">
        ...
        <div class="col-8">
           {!! Form::text('remarks', $batch->remarks ?? null, ['class' => 'form-control form-select-sm', 'placeholder' => 'Type here...', 'required',
            config(is_disable(category_type() ?? $material_product->category_selection)."remarks.status")
           ]) !!}
        </div>
    </div>
</div>