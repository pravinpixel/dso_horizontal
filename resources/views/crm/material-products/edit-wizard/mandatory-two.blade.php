...
{!! Form::open(['route' => ['edit-mandatory-form-two', $material_product->id], 'id' => 'wizzard_form_two', 'class' => 'row wizzard-form', 'method'=> 'post','files'=>true]) !!}
    <div class="card-body row">
        @include('crm.material-products.fields.mandatory-two')
    </div>
    <div class="card-footer border-top bg-light"> 
        <a href="{{ route('material-product.edit-form-one', $material_product->id) }}" class="btn btn-light rounded-pill shadow-sm border">
