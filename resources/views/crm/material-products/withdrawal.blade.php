		  ...
		  <div class="col-6 d-flex justify-content-end ms-auto text-end">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="topnav-ecommerce" >
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Products</label>
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Products Details</label>
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Orders</label>
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Order Details</label>
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Customers</label>
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Shopping Cart</label>
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Checkout</label>
                    <label class="dropdown-item"><input type="checkbox" class="form-check-input me-1" /> Sellers</label>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    <tr>
					 <td class="child-td"> Acetone IND</td>
                        ...
                        <td class="child-td"><input type="number" min="1"  name="" id="" class="form-control w-50 text-center mx-auto p-0" value="10"></td>
                        ...
                        <tr class="bg-secondary text-white">
						   <td class="child-td">Prepreg C3K</td>
                            ...
                            <td class="child-td">Roll2/1</td>
							 <td class="child-td">0.5L</td>
                            <td class="child-td"><input type="number" min="1"  disabled name="" class="form-control w-auto p-0 form-control-sm text-center" value="10"></td>
