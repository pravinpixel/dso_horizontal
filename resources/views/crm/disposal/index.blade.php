@extends('layouts.app')
@section('content')  
    <div ng-app="SearchAddApp" ng-controller="SearchAddController" ng-init="disposal_status_batch_id = '{{ request()->route()->id ?? 'null' }}'">
        ...
        {{-- ======= START : App Models ==== --}}
            ...
            @include('crm.material-products.modals.early-disposal')
        {{-- ======= END : App Models ==== --}}
    </div>
@endsection
@section('styles')
